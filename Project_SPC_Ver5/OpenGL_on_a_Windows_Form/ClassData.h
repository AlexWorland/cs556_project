...
public: 
	...
	void drawPlot(float x, float y, float plotW, float plotH, int plotNum) 
	{
			...
			float plotWidthFraction = plotWidth / 3;
			drawBitmapText(xLabelArr, x1CoordPlot[plotNum] + plotWidthFraction, y2CoordPlot[plotNum] + xLabelVeritcalOffset);
			drawBitmapText(yLabelArr, x1CoordPlot[plotNum] + plotWidthFraction, y2CoordPlot[plotNum] + yLabelVerticalOffset);
			...
			drawBitmapText(plotAsArr, x1CoordPlot[plotNum] + plotWidthFraction, y2CoordPlot[plotNum] + plotIdOffset);
			//if (!fOpen)
			//{
